...
<body>
  ...
  <header class="masthead text-center text-white">
    <div class="masthead-content">
        {if isset($result)}
	<h4 class="masthead-heading mb-0" >Wynik {$result}</h4>
        {/if}
    </div>
    ...
    <div class="container" id="main-content">
      <div class="row align-items-center">
        <div class="col-lg-6 order-lg-1" style="margin:auto">
           <form class="form-group" action="{$app_url}/app/calc_credit.php" method="post" id="kredytowy" style="display:block">
            ...
            <form class="form-group" action="{$app_url}/app/calc.php" method="post" id="klasyczny" style="display:none">
